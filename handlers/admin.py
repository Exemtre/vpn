...
GLOBAL_EMOJI_KEYS = {
    ...
    # Экран подключённых устройств / Профиль
    "ge_conn_header":   "Эмодзи заголовка «Статус подключения» (замена 📡)",
    "ge_conn_status":   "Эмодзи строки «Статус:» (замена 🔹)",
    "ge_conn_activity": "Эмодзи строки «Последняя активность:» (замена 🔹)",
    "ge_conn_traffic":  "Эмодзи строки «Использовано трафика:» (замена 🔹)",
    "ge_conn_sub_url":  "Эмодзи строки «Ссылка подписки:» на экране устройств (замена 🌐)",
    # Уведомления
    "ge_notif_expiry": "Эмодзи заголовка уведомления об истечении подписки (замена ⚠️)",
    "ge_notif_noconn": "Эмодзи заголовка уведомления «не подключился» (замена 🤖)",
}
